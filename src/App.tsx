...
/** Redirect old judging hub URL to split pages */
  ...
  const targetPath =
    tab === 'assign'
      ...
      : tab === 'report'
        ? 'reports'
        : 'reviews'
  return <Navigate to={`${buildAdminPath(adminBasePath, targetPath)}`} replace />
}
      ...
      <Suspense fallback={<RouteLoader />}>
        <Routes>
          ...
          >
            ...
            <Route path="reviews" element={<Judging />} />
          ...
          <Route
            path="/judge"
            element={
              <RequireRole allowedRoles={['judge']} redirectTo={adminLoginPath}>
                <JudgeLayout />
              </RequireRole>
            }
          >
